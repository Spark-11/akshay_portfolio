    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/Spark-11/"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/akshay-saini-34b784249/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
      ...
      {/* Mobile menu items */}
      {isOpen && (
        <div className="absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#050414a9] bg-opacity-50 backdrop-blur-lg z-50 rounded-lg shadow-lg md:hidden">
